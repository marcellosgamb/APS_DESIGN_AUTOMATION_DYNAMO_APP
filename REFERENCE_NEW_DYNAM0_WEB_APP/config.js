...
module.exports = {
    ...
    designAutomation: {
        nickname: process.env.APS_NICKNAME || 'DynamoApp',
        activityId: process.env.APS_ACTIVITY_ID || 'DeleteWallsActivity',
        appBundleId: process.env.APS_APPBUNDLE_ID || 'DeleteWalls'
    },
    scopes: {
