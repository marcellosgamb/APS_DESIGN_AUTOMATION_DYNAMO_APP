...
function createAppBundleActivity() {
    startConnection(function () {
        ...
        // Step 1: Create nickname
        jQuery.ajax({
            url: 'api/aps/designautomation/nickname',
            method: 'GET',
            success: function (res) {
                writeLog('Nickname: ' + res.nickname);
                // Step 2: Create/upload appbundle
...
function startWorkitem() {
    ...
    var file2 = inputDynamoFile.files[0];

    startConnection(function () {
        // Step 1: Create bucket and upload files
        ...
        writeLog('Uploading input files...');
        $.ajax({
